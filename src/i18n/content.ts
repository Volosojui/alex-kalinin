  ...
  journey: {
    ...
    jobs: [
      ...
      },
      {
        ...
        highlights: [
          "Разработал frontend образовательной marketplace-платформы с нуля",
          "Добавил поддержку нескольких языков (next-intl)",
      ...
      },
      {
        ...
        highlights: [
          ...
          "Организовал процессы фронтенд-команды: code review, планирование задач, обмен знаниями с коллегами",
